...
var commands = map[string]commandEntry{
	...
	"recall":    {cmdRecall, "recall <query> --scope <scope> [--top N] [--type t] [--tags a,b] [--since d] [--until d] [--agent a] [--inherit] [--children] [--caller-agent a] [--reranker r] [--include-links] [--include-suggested] [--interactive]", []string{"--scope", "--top", "--type", "--tags", "--since", "--until", "--agent", "--inherit", "--children", "--caller-agent", "--reranker", "--include-links", "--include-suggested", "--interactive"}},
